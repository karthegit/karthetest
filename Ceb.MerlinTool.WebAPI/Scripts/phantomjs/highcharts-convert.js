(function () {
	...
	var config = {
			...
			files: { 
			    ...
			    HIGHCHARTS_DATA: 'datajs-1.1.2.min',
				...
				HIGHCHARTS_REGRESSION: 'highcharts-regression.js',
				/*HIGHCHARTS_MAP: 'map.js',*/
				HIGHCHARTS_SOLID_GAUGE: 'solid-gauge.src.js',
				HIGHCHARTS_GROUPED_CATEGORIES: 'grouped-categories.js'
			},
